...
let title = createElement('h1', 'title', 'Game of "rock paper scissors"');
let game = createElement('div', 'game-field');
let resultText = createElement('h3', 'result-text', 'Make your choice');
let reset = createElement('button', 'btn-reset', 'Restart');
...
let gameOver = () => {
  ...
  switch (result) {
    ...
    case "rockscissors":
    case "scissorspaper":
      resultText.innerHTML = "You are a winner!";
    ...
    case "scissorsrock":
    case "paperscissors":
      resultText.innerHTML = "Computer a winner!";
