$(document).ready(function (){
    let arr = [{
        quest: 'В каком городе находится футбольный клуб "Челси"?',
        answ: 'Лондон',
    },
    {
        quest: 'Фамилия ведущего передачи "Поле Чудес"',
        answ: 'Якубович',
    },{
        quest: 'Спортсменом какой дисциплины является Усик?',
        answ: 'Бокс',
    },{
        quest: 'Как звали сына Муфаса',
        answ: 'Симба',
    },{
        quest: 'В каком городе самое короткое метро в мире?',
        answ: 'Днепр',
    },{
        quest: 'Президентом какой страны является Зеленский',
        answ: 'Украина',
    }]
